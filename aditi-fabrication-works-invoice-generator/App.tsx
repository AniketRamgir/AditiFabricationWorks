          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="flex flex-col gap-2 items-start md:items-end">
                <div className="flex items-center w-full md:w-auto">
                    ...
                    {isPrinting ? <span className="p-2 font-medium">{invoiceNumber}</span> : <input type="text" className="p-2 border rounded-md flex-1" value={invoiceNumber} onChange={(e) => setInvoiceNumber(e.target.value)} />}
                </div>
                <div className="flex items-center w-full md:w-auto">
